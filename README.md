...
[![Build Status](https://github.com/ember-graphql/ember-apollo-client-fixed/workflows/CI/badge.svg)](https://github.com/ember-graphql/ember-apollo-client-fixed/actions)
[![Ember Observer Score](https://emberobserver.com/badges/ember-apollo-client-fixed.svg)](https://emberobserver.com/addons/ember-apollo-client-fixed)
...
import { queryManager } from "ember-apollo-client-fixed";
...
```js
import Route from "@ember/routing/route";
import { getObservable, queryManager} from "ember-apollo-client-fixed";
...
In `ember-apollo-client-fixed`, most unsubscriptions are handled automatically by the
...
import { unsubscribe } from "ember-apollo-client-fixed";
import { inject as service } from '@ember/service';
...
If your application has a custom apollo service or multiple apollo services that extends from `ember-apollo-client-fixed/services/apollo`, you can use this option to specify which apollo service to use.
...
Note: The `graphql` module above is included when you `ember install ember-apollo-client-fixed`.
...
* [Acceptance test for a regular query](https://github.com/ember-graphql/ember-apollo-client-fixed/blob/master/tests/acceptance/query-and-unsubscribe-test.js)
* [Route integration test for a mutation with a fragment](https://github.com/ember-graphql/ember-apollo-client-fixed/blob/master/tests/unit/routes/new-review-test.js)

The tests also contain a sample Star Wars GraphQL schema with an
[pretender setup][pretender-setup] for mock data.

[pretender-setup]: https://github.com/ember-graphql/ember-apollo-client-fixed/blob/master/tests/helpers/start-pretender.js

## Development

### Installation

* `git clone https://github.com/ember-graphql/ember-apollo-client-fixed` this repository
* `cd ember-apollo-client-fixed`
* `yarn install`
